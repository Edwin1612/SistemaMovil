        ...
        public function enlacesPaginasModel($enlacesModel){
          ...
          if($_SESSION["tipoUsuario"]==0)
          {
              if($enlacesModel == "index" || $enlacesModel == "cerrarSesion" || $enlacesModel == "categorias"
                ...
                || $enlacesModel == "premios" || $enlacesModel == "registrarVisita" || $enlacesModel == "promociones" || $enlacesModel == "horario" || $enlacesModel == "inicio1"
                || $enlacesModel == "inicio0" || $enlacesModel == "editarPromocion" || $enlacesModel == "perfilPremio"){
